...
std::vector<Node::SharedIdentifier> GenerateIdentifiers(std::size_t count);
std::optional<Message::Application::Parcel> GenerateRequest(Message::Context const& context);
std::optional<Message::Application::Parcel> GenerateResponse(
    Message::Context const& context, Node::SharedIdentifier const& spSource, Awaitable::TrackerKey const& key);
...
inline std::vector<Node::SharedIdentifier> Awaitable::Test::GenerateIdentifiers(std::size_t count)
{
    ...
    identifiers.emplace_back(spServerIdentifier);
    return identifiers;
}

//----------------------------------------------------------------------------------------------------------------------

inline std::optional<Message::Application::Parcel> Awaitable::Test::GenerateRequest(Message::Context const& context)
{
    return Message::Application::Parcel::GetBuilder()
        .SetContext(context)
        .SetSource(ClientIdentifier)
        .SetDestination(*spServerIdentifier)
    ...
    Message::Context const& context, Node::SharedIdentifier const& spSource, Awaitable::TrackerKey const& key)
{
    return Message::Application::Parcel::GetBuilder()
        .SetContext(context)
        .SetSource(*spSource)
        .SetDestination(ClientIdentifier)
