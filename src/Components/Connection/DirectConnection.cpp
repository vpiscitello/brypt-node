...
{
    NodeUtils::printo("[Direct] Creating direct instance", NodeUtils::PrintType::Connection);
...
{
    NodeUtils::printo("[Direct] I am a Direct implementation", NodeUtils::PrintType::Connection);
}
...
{
    NodeUtils::printo("[Direct] Spawning DIRECT connection thread", NodeUtils::PrintType::Connection);
    ...
    switch (m_operation) {
        ...
        case NodeUtils::ConnectionOperation::Server: {
            NodeUtils::printo("[Direct] Setting up REP socket on port " + m_port, NodeUtils::PrintType::Connection);
...
{
    NodeUtils::printo("[Direct] Shutting down socket and context", NodeUtils::PrintType::Connection);
...
void Connection::CDirect::ServerWorker()
{
    ...
    do {
        ...
        if (optReceivedRaw) {
            NodeUtils::printo("[Direct] Received request: " + *optReceivedRaw, NodeUtils::PrintType::Connection);
            ...
            try {
                ...
                NodeUtils::printo("[Direct] Received message failed to unpack.", NodeUtils::PrintType::Connection);
            }
...
std::optional<std::string> Connection::CDirect::Receive(zmq::recv_flags flag)
{
    ...
    NodeUtils::printo("[Direct] Received: " + request, NodeUtils::PrintType::Connection);
