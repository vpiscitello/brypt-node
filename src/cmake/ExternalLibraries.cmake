...
if (NOT Boost_FOUND)
    ...
    set(BOOST_CONFIGURE_PARAMS
        --prefix=${BOOST_DIRECTORY} --with-python=python3)

    set(BOOST_BUILD "./b2")
    set(BOOST_BUILD_PARAMS
        --threading=multi --link=shared --variant=release --layout=system --build-type=minimal -j4)
    ...
    ExternalProject_Add(
        ...
        PATCH_COMMAND ""
        CONFIGURE_COMMAND
            ${BOOST_CONFIGURE} ${BOOST_CONFIGURE_PARAMS}
        BUILD_COMMAND
            ${BOOST_BUILD} ${BOOST_BUILD_PARAMS}
        INSTALL_COMMAND
...
message(DEBUG "Boost_LIBRARY: ${Boost_LIBRARIES}")
...
if (NOT GTEST_FOUND)
    ...
    set(GOOGLETEST_CONFIGURE_PARAMS -DCMAKE_INSTALL_PREFIX=${GOOGLETEST_DIRECTORY})
    ...
    set(GTEST_LIBRARIES ${GOOGLETEST_DIRECTORY}/lib/libgtest.a)
endif()
...
if (NOT OPENSSL_FOUND)
    ...
    ExternalProject_Add(
        ...
        BUILD_COMMAND
            ${OPENSSL_BUILD} build_generated
        INSTALL_COMMAND
            ${OPENSSL_BUILD} install_sw
        INSTALL_DIR ${OPENSSL_DIRECTORY})

    set(OPENSSL_INCLUDE_DIR ${OPENSSL_DIRECTORY}/include)
    set(OPENSSL_CRYPTO_LIBRARY ${OPENSSL_DIRECTORY}/lib/libcrypto.so)    
endif()
...
if (NOT EXISTS ${OQS_DIRECTORY}/lib/liboqs.so)
    ...
    set(OQS_CONFIGURE_PARAMS
        -DBUILD_SHARED_LIBS=ON -DOPENSSL_ROOT_DIR=${OPENSSL_ROOT_DIR} -DCMAKE_INSTALL_PREFIX=${OQS_DIRECTORY})
